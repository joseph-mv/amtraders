...
"
            ...
            <div className="w-full md:w-1/2 bg-gray-100 p-6 border border-black rounded-xl shadow-xl">
              ...
              <form action={handleContactForm} className="space-y-3">
                <div>
                ...
                <button
                  type="submit"
                  className="w-full mt-3 p-2 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition"
                >
                  Send Message
                </button>
              </form>
