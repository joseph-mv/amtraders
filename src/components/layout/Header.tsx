      ...
      <div className="flex items-center gap-3">
        ...
        <button className="order-1 md:hidden relative z-20 w-[30px] h-[20px]">
          ...
          >
            <input
              ...
              onChange={toggleMenu}
            />
            <span className="absolute top-0 block h-[4px] w-full origin-left transition-all bg-btn-primary-bg peer-checked:rotate-45 peer-checked:left-[4.5px]"></span>
            <span className="absolute top-[50%] block h-[4px] w-full  bg-btn-primary-bg  peer-checked:bg-transparent"></span>
            <span className="absolute top-[100%]  block h-[4px]  w-full origin-left transition-all bg-btn-primary-bg  peer-checked:-rotate-45 peer-checked:left-[4.5px] peer-checked:top-[21px]"></span>
          </label>
        </button>
        ...
        >
          {navLinks.map(({ href, icon, label }) => (
            <div
              key={href}
              className=" border-b-1 text-text-primary border-gray-400 p-2 md:border-none"
            >
